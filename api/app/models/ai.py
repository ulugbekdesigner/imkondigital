...
class ZiyoMessage(Base):
    """Suzuvchi Ziyo vidjetining tarixi — faqat kirgan foydalanuvchilar uchun.

    Simli protokol o'zgarishsiz statesiz qoladi (frontend har so'rovda oxirgi
    xabarlarni o'zi yuboradi) — bu shunchaki javob hisoblab bo'lingandan keyin
    qo'shimcha yozib qo'yiladigan jurnal, panel ochilganda o'qish uchun.
    Amaliyot (practice) rejimidagi xabarlar ATAYLAB bu yerga yozilmaydi (
    app/modules/ai/ziyo.py'ga qarang) — aks holda keyingi standart savolga
    Gemini kontekstiga chet tilidagi rolli-o'yin xabarlari aralashib qoladi.
    """

    __tablename__ = "ziyo_messages"
