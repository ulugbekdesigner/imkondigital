...
/** /ustoz (mentorlik) xato holati — docs/design/README.md majburiy holat qoidasi
 * (.imk-error + "Qayta urinish"). Server komponent ma'lumot ololmasa
 * (masalan getMe/getMentors/getMyMentorships so'rovlaridan biri kutilmagan
 * xato bersa) foydalanuvchi bo'sh ekran o'rniga shu ko'radi. */
export default function UstozError({
  error,
  reset,
}: {
    ...
    <div className="relative mx-auto max-w-2xl px-4 py-10">
      <div className="imk-error" role="alert">
        ...
        <div className="flex flex-col gap-1">
          <p className="font-sans text-base font-bold text-ink">Mentorlik sahifasini yuklab bo&apos;lmadi</p>
