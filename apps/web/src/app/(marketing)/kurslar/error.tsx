...
/** /kurslar xato holati — docs/design/README.md majburiy holat qoidasi
    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      <div className="imk-error" role="alert">
        ...
        <div className="flex flex-col gap-1">
          <p className="font-sans text-base font-bold text-ink">Kurslar katalogini yuklab bo&apos;lmadi</p>
