...
/** multipart/form-data (tasdiqlovchi hujjat) — xom oqim sifatida backend'ga uzatiladi. */
export async function POST(request: Request): Promise<NextResponse> {
  ...
  const res = await fetch(`${API_INTERNAL_URL}/v1/users/me/disability-profile/document`, {
    method: 'POST',
