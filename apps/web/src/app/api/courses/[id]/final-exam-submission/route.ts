...
/** multipart/form-data (fayl bilan bo'lishi mumkin) — xom oqim sifatida backend'ga uzatiladi. */
export async function POST(
  ...
  const res = await fetch(`${API_INTERNAL_URL}/v1/courses/${params.id}/final-exam-submission`, {
    method: 'POST',
