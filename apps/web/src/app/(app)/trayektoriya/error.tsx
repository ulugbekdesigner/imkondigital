...
/** Trayektoriya xato holati — docs/design/README.md majburiy holat qoidasi
 * (.imk-error + "Qayta urinish"). Server komponent trayektoriyani ololmasa
 * yoki kutilmagan xato bo'lsa, foydalanuvchi bo'sh ekran o'rniga shu ko'radi. */
export default function TrayektoriyaError({
  error,
  reset,
}: {
    ...
    <div className="mx-auto max-w-2xl px-4 py-10">
      <div className="imk-error" role="alert">
        ...
        <div className="flex flex-col gap-1">
          <p className="font-sans text-base font-bold text-ink">Trayektoriyani yuklab bo&apos;lmadi</p>
