...
/** "Mening yo'lim" xato holati — docs/design/README.md majburiy holat qoidasi
 * (.imk-error + "Qayta urinish"). Server komponent ma'lumot ololmasa yoki
 * kutilmagan xato bo'lsa, foydalanuvchi bo'sh ekran o'rniga shu ko'radi. */
export default function MeningYolimError({
  error,
  reset,
}: {
    ...
    <div className="mx-auto max-w-6xl">
      <div className="imk-error" role="alert">
        ...
        <div className="flex flex-col gap-1">
          <p className="font-sans text-base font-bold text-ink">Yo&apos;limni yuklab bo&apos;lmadi</p>
